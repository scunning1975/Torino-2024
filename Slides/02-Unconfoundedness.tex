...
\begin{frame}{Known and Quantified Confounder}
	...
	\item Randomizing the treatment allows us to estimate causal effects -- but we must have the correct confounders
	\end{itemize}
...
\begin{itemize}
\item Covariate adjustment strategies like regression or matching can identify average treatment effects (ATE, ATT, ATU)
\item With constant treatment effects, they are the same ($ATT=ATE=ATU$) so methods that find one find all of them
...
\begin{frame}{Titanic Layout}
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{./lecture_includes/titanic.png}
        \caption{Layout of the Titanic into first class and lower decks}
    \end{figure}
\end{frame}
