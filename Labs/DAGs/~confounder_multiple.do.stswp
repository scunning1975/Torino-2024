********************************************************************************
* name: confounder_multiple.do
* author: scott cunningham (baylor)
* description: "Multiple strategies" DAG slide
...
program define sim, rclass
  ...
  * Regressions
  reg earnings treat, robust
  return scalar ols_naive = _b[treat]
...
simulate ols_naive = r(ols_naive) ols3 = r(ols3) ols23 = r(ols23) ols13=r(ols13) ols12 = r(ols12) ols123 = r(ols123), reps(100): sim
sum
