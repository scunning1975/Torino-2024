...
** RA for ATT	
	...
	* Method 1: use TEFFECTS for Regression adjustment
	...
	* Method 2: Fully interact and recover parameters. Regression adjustment "the long way". At its core, regression adjustment "interacts" the treatment variable with all of the covariates. 	
...
* Method 3. RA using Kitagawa-Oaxaca-Blinder 
